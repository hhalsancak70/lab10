...
class _NotificationPageState extends State<NotificationPage> {
  ...
  void _scheduleNotification() {
    ...
    final durationInSeconds = _calculateDuration();
    _showSnackBar('Notification scheduled in $_selectedTime $_selectedUnit.');

    _timer = Timer(Duration(seconds: durationInSeconds), _showNotification);
  }
  ...
  void _cancelNotification() {
    if (_timer != null) {
      _timer!.cancel();
      _showSnackBar('Scheduled notification canceled.');
    }
  }
    ...
    showDialog(
      ...
      builder: (context) {
        return AlertDialog(
          ...
          content:
              const Text('Do you want to cancel the scheduled notification?'),
          actions: [
            TextButton(
              onPressed: () => Navigator.pop(context),
              child: const Text('No'),
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            // Button to cancel the scheduled notification
            OutlinedButton(
              onPressed: _confirmCancelNotification,
              style: OutlinedButton.styleFrom(
                padding:
